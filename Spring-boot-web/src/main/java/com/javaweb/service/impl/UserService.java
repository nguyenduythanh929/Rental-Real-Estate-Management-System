...
public class UserService implements IUserService {
    ...
    @Override
    public List<UserEntity> getAssignedBuildingStaffs(Long buildingId) {
        List<UserEntity> staffs = userRepository.findByBuildings_Id(buildingId);
        return new ArrayList<>(staffs);
    }

    @Override
    public List<UserEntity> getAssignedCustomerStaffs(Long customerId) {
        List<UserEntity> staffs = userRepository.findByCustomers_Id(customerId);
        return new ArrayList<>(staffs);
    }
    ...
    @Override
    public UserDTO insertFromRegister(UserDTO newUser) throws Exception{
        if(userRepository.findOneByUserNameAndStatus(newUser.getUserName(), 1) != null){
