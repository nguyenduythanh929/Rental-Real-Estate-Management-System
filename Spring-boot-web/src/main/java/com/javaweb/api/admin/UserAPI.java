...
public class UserAPI {
    ...
    public ResponseEntity<UserDTO> registerUsers(@RequestBody UserDTO newUser) throws Exception {
        return ResponseEntity.ok(userService.insertFromRegister(newUser));
    }
