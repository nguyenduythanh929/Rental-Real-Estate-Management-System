        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 col-md-6">
                    ...
                    <form:form class="form-horizontal" role="form" id="form-edit" action="/lien-he" method="GET" modelAttribute="customerEdit">
                        <div class="row">
                        ...
                        <div class="form-group">
                            <form:input class="form-control" path="demand" placeholder="Nhu cầu"/>
                        </div>
                        <button type="button" class="btn btn-primary px-4 mt-3" id="btnSubmit">
                            Gửi liên hệ
                        </button>
                    </form:form>
                </div>
